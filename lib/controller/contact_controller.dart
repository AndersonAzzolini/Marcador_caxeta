...
class ContactController extends GetxController {
  ...
  void launchURL(urlUser) async => await canLaunch(_url + urlUser)
      ? await launch(_url + urlUser)
  ...
  void configurandoModalBottomSheet(index) {
    Get.bottomSheet(
        Container(
          child: Wrap(
            children: <Widget>[
              ListTile(
                  ...
                  onTap: () => {print(index.foto)}),
              ListTile(
                  leading: new Icon(Icons.edit),
                  title: new Text('URL'),
                  onTap: () => {print(index.site), launchURL(index.site)}),
              ListTile(
                leading: new Icon(Icons.delete),
                title: new Text('Excluir'),
                onTap: () => {deleteContact(index.id, index.foto)},
              ),
            ],
          ),
        ),
